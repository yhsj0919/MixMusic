...
/**
 * 代码来自
 * https://github.com/781flyingdutchman/background_downloader
 */
class DownloadManager {
  ...
  Future<List<DownloadTask?>?> whenBatchDownloadsComplete(List<String> urls, {Duration timeout = const Duration(hours: 2)}) async {
