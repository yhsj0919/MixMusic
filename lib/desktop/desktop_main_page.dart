...
class _DesktopMainPageState extends State<DesktopMainPage> {
  ...
  late final List<NavigationPaneItem> originalItems =
      [
        ...
        PaneItemSeparator(),
        PaneItemHeader(
          header: Container(padding: EdgeInsets.only(left: 6, bottom: 6), child: Text('音乐')),
        ),
        ...
        Expanded(
          child: NavigationView(
            appBar: NavigationAppBar(
              ...
              leading: null,
              title: Text('MixMusic', style: FluentTheme.of(context).typography.bodyLarge),
            ...
            pane: NavigationPane(size: NavigationPaneSize(openWidth: 250), selected: _calculateSelectedIndex(context), items: originalItems, footerItems: footerItems),
