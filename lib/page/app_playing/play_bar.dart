    ...
    return context.isLandscape
        ...
        : Obx(
            () => music.currentMusic.value == null
                ? Container()
                : AnimatedTheme(
                    data: ThemeData(colorSchemeSeed: theme.playingColor.value ?? Theme.of(context).colorScheme.primary, brightness: Theme.of(context1).brightness),
                    child: LayoutBuilder(
                      builder: (BuildContext context, BoxConstraints constraints) {
                        return Container(
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              // 添加阴影
                              BoxShadow(color: Theme.of(context).brightness == Brightness.light ? Colors.black26 : Colors.white24, blurRadius: 5.0, offset: Offset(0, 4)),
                            ],
                          ),
                          child: Stack(
                            children: [
                                          ...
                                          Hero(
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: music.currentMusic.value == null
                                                  ? Container(color: Theme.of(context).shadowColor.withOpacity(0.1), width: 56, height: 56)
                                                  : Obx(() => AppImage(url: music.currentMusic.value?.pic ?? "", width: 56, height: 56, fit: BoxFit.cover)),
                                            ),
                                          ),
                                          Obx(() => MixSiteItem(mixSong: music.currentMusic.value, size: 15)),
                                        ],
                                      ),
                                    ),
                                  ),
