      ...
      body: HyperBackground(
        child: CustomScrollView(
          slivers: [
            ...
            //           AppDB.setBool(Constant.KEY_PLAY_WITH_OTHER_APP, value);
            //
            ...
            Obx(() => HyperGroup(
                  ...
                  children: [
                    RadioListTile<int?>(
                      ...
                      value: 128,
                      onChanged: (int? value) {
                        AppDB.setInt(Constant.KEY_PLAY_QUALITY, value ?? 128);
                    ...
                    RadioListTile<int?>(
                      ...
                      value: 320,
                      onChanged: (int? value) {
                        AppDB.setInt(Constant.KEY_PLAY_QUALITY, value ?? 320);
                    ...
                    RadioListTile<int?>(
                      ...
                      value: 1000,
                      onChanged: (int? value) {
                        AppDB.setInt(Constant.KEY_PLAY_QUALITY, value ?? 1000);
                    ...
                    RadioListTile<int?>(
                      ...
                      value: 2000,
                      onChanged: (int? value) {
                        AppDB.setInt(Constant.KEY_PLAY_QUALITY, value ?? 2000);
                    ...
                    RadioListTile<int?>(
                      ...
                      value: 3000,
                      onChanged: (int? value) {
                        AppDB.setInt(Constant.KEY_PLAY_QUALITY, value ?? 3000);
