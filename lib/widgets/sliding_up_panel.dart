...
class _SlidingUpPanelState extends State<SlidingUpPanel> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _sc.addListener(() {
      if (widget.isDraggable && !widget.disableDraggableOnScrolling && (!_scrollingEnabled || _panelPosition < 1) && widget.controller?._forceScrollChange != true) {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        // Here you can access the constraints
          ...
          children: <Widget>[
            ...
            widget.body != null
                ? AnimatedBuilder(
                    ...
                    child: Container(
                      height: stackHeight - widget.bottomOffset,
                      width: stackWidth,
                      child: widget.body,
                    ),
                  )
            ...
            (!_isPanelVisible || widget.collapsed == null)
                ? Container()
                : _gestureHandler(
                    child: AnimatedBuilder(
                      animation: _ac,
                      ...
                      child: Stack(
                        children: <Widget>[
                          ...
                          Positioned(
                              ...
                              width: stackWidth - (widget.margin != null ? widget.margin!.horizontal : 0) - (widget.padding != null ? widget.padding!.horizontal : 0),
                              child: Container(
                          ...
                          Positioned(
                            ...
                            child: SizedBox(
                              ...
                              child: widget.collapsed == null
                                  ? Container()
                                  : FadeTransition(
                                      opacity: Tween(begin: 1.0, end: -3.0).animate(_ac),
...
class PanelController {
  ...
  ///临时关闭手势
  void tempDisableSlide(bool disable) {
    _panelState!.tempDisableSlide = disable;
  }
